...
```
1. Load table (powerquery refresh load_destination="data-model")
2. THEN create relationships (datamodel with create-relationship action)
...
After relationship: datamodel list-relationships
